...
Rule3
ON button1#state=3 DO Backlog Power1 2; Var1 1; Var2 0; Var3 0; Var4 0 ENDON
ON Button1#State=10 DO IF (%Var1%==0) Var2 1; Add3 3600; Power1 1 ENDIF ENDON
ON Button1#State=11 DO IF (%Var1%==0) Backlog Var2 1; Add3 7200; Power1 1 ENDIF ENDON
ON Button1#State=12 DO IF (%Var1%==0) Backlog Var2 1; Add3 10800; Power1 1 ENDIF ENDON
ON Button1#State=13 DO IF (%Var1%==0) Backlog Var2 1; Add3 14400; Power1 1 ENDIF ENDON
ON Button1#State=14 DO IF (%Var1%==0) Backlog Var2 1; Add3 18000; Power1 1 ENDIF ENDON
ON Var3#state DO IF (%Var2%==1) RuleTimer1 %Var3%; RuleTimer2 60 ENDIF ENDON
ON Rules#Timer=1 DO Power1 0 ENDON
ON Rules#Timer=2 DO Sub3 60 ENDON
ON Energy#Power<10 DO IF (%Var4%==0) Var4 1; RuleTimer3 60 ENDIF ENDON
ON Energy#Power>10 DO Backlog Var4 0; RuleTimer3 0 ENDON
ON Rules#Timer=3 DO Power1 0 ENDON
ON Power1#State=0 DO Backlog Var1 0; Var2 0; Var3 0; Var4 0; RuleTimer1 0; RuleTimer2 0 ENDON


Rule3
ON button1#state=3 DO Backlog Power1 2; Var1 1; Var2 0; Var3 0 ENDON
ON Button1#State=10 DO IF (%Var1%==0) Var2 1; Add3 3600; Power1 1 ENDIF ENDON
ON Button1#State=11 DO IF (%Var1%==0) Backlog Var2 1; Add3 7200; Power1 1 ENDIF ENDON
ON Button1#State=12 DO IF (%Var1%==0) Backlog Var2 1; Add3 10800; Power1 1 ENDIF ENDON
ON Button1#State=13 DO IF (%Var1%==0) Backlog Var2 1; Add3 14400; Power1 1 ENDIF ENDON
...
ON Rules#Timer=1 DO Power1 0 ENDON
ON Rules#Timer=2 DO Sub3 60 ENDON
ON Power1#State=0 DO Backlog Var1 0; Var2 0; Var3 0 RuleTimer1 0; RuleTimer2 0 ENDON
ON Power1#State=1 DO RuleTimer3 5 ENDON
ON Rules#Timer=3 DO Status 10; IF (%energy_power%<10) Power1 0 ENDIF; RuleTimer3 60 ENDON
